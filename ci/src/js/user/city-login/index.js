/*
 * @Author: fuhao 
 * @Date: 2018-05-02 10:40:46 
 * @Last Modified by: fuhao
 * @Last Modified time: 2018-05-05 20:14:43
 */
...
$(function () {
    ...
    $("#js_login_submit").bind("click", function () {
	 ...
	 $("#js_login_submit_a").bind("click", function () {
        var submit_url = $('#url_adminlogin').val();
		var userId = $("#js_user_id").val(); //获取用户id输入框的值
		 var pswVal = $("#js_passw").val();
			...
			$.post(submit_url, param, function (data) {
...
function btnSubmit() {
    ...
    $.post(API.ADMIN.CITYLOGIN, data, function (data) {
