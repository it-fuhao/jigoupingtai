...
$(function(){
    ...
    var areaSelect = new MobileSelect({
        ...
        callback: function (indexArr, data) {
            ...
            console.log(data);
            $('#area_trigger').text(data[0].value + ' / ' + data[1].value)
            $('#area_trigger').parents('dl').attr('data-d', data[0].id+'/'+data[1].id);
    ...
    $('#js_submit').on('click', function () {
        ...
        if (_flag) {
            ...
            var pro_id = $('.list').attr('data-d').split('/')[0];
            var city_id = $('.list').attr('data-d').split('/')[1];
            var param = {
                'pro_id': pro_id,
                'city_id': city_id,
